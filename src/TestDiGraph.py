...
class MyTestCase(unittest.TestCase):
    ...
    def test_v_size(self):
        ...
        self.assertEqual(8, self.graph.v_size(), "remove edge the num of nodes not change")
        graph.remove_node(2)
        self.assertEqual(7, self.graph.v_size(), "remove node from the graph")
        graph.remove_node(2)
        self.assertEqual(7, self.graph.v_size(), "remove node that not exist")
